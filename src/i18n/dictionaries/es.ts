...
export const es: Dictionary = {
  ...
  trackingPage: {
    ...
    steps: [
      ...
      {
        title: "Presupuesto",
        description: "El precio y el plazo han sido confirmados.",
      },
      {
        title: "Desarrollo",
        description: "El sitio está en construcción, con puntos de seguimiento regulares.",
      },
      {
        title: "Entrega",
        description: "El sitio está en línea. Quedan disponibles dos rondas de ajustes.",
      },
    ],
    ...
    summaryHeading: "Su proyecto",
    todayHeading: "En qué punto está su proyecto hoy",
    updatesHeading: "Actualizaciones del proyecto",
    updatesEmpty:
      "Las actualizaciones del proyecto aparecerán aquí a medida que avance el trabajo.",
    previewCta: "Ver la vista previa del sitio",
    filesHeading: "Imágenes y maquetas",
    approveHeading: "El sitio está listo para su revisión",
    approveDescription:
      "Consulte la vista previa de arriba y luego apruébela para iniciar la puesta en línea.",
    approveButton: "Apruebo, listo para la puesta en línea",
    approvedNotice: "Ha aprobado el sitio — la puesta en línea se está preparando.",
    overviewNavLabel: "Resumen",
    paymentsNavLabel: "Pago",
    paymentsHeading: "Pagos",
    paymentsSubtitle: "Su anticipo y saldo, en un solo lugar.",
    paymentsEmpty: "Aún no hay pagos.",
    payNowLabel: "Pagar ahora",
    payErrorLabel: "Se produjo un error, inténtelo de nuevo o contacte a Thomas.",
    paidLabel: "Pagado",
    paymentSuccessNotice: "Pago recibido, ¡gracias!",
  },
  notFoundPage: {
    eyebrow: "404",
