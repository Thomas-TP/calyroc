...
export const it: Dictionary = {
  ...
  faqPage: {
    ...
    searchNoResults: "Nessuna domanda corrisponde alla tua ricerca.",
    allCategoryLabel: "Tutte",
    generalCategoryLabel: "Generale",
    items: [
      {
  ...
  trackingPage: {
    ...
    steps: [
      {
        title: "Contatto",
        description: "La Sua richiesta è stata ricevuta.",
      },
      {
        title: "Preventivo",
        description: "Il prezzo e i tempi sono stati confermati.",
      },
      {
        title: "Sviluppo",
        description: "Il sito è in fase di realizzazione, con aggiornamenti periodici.",
      },
      {
        title: "Consegna",
        description: "Il sito è online. Restano disponibili due round di modifiche.",
      },
    ],
    ...
    summaryHeading: "Il Suo progetto",
    todayHeading: "A che punto è il Suo progetto oggi",
    updatesHeading: "Aggiornamenti del progetto",
    updatesEmpty: "Gli aggiornamenti del progetto appariranno qui man mano che il lavoro procede.",
    previewCta: "Vedi l'anteprima del sito",
    filesHeading: "Immagini e bozze",
    approveHeading: "Il sito è pronto per la revisione",
    approveDescription: "Consulti l'anteprima qui sopra, poi approvi per avviare la pubblicazione.",
    approveButton: "Approvo, pronto per la pubblicazione",
    approvedNotice: "Ha approvato il sito — la pubblicazione è in preparazione.",
    overviewNavLabel: "Panoramica",
    paymentsNavLabel: "Pagamento",
    paymentsHeading: "Pagamenti",
    paymentsSubtitle: "Il Suo acconto e saldo, in un unico posto.",
    paymentsEmpty: "Nessun pagamento per ora.",
    payNowLabel: "Paga ora",
    payErrorLabel: "Si è verificato un errore, riprovi o contatti Thomas.",
    paidLabel: "Pagato",
    paymentSuccessNotice: "Pagamento ricevuto, grazie!",
  },
  notFoundPage: {
    eyebrow: "404",
  ...
  email: {
    ...
    paymentLink: {
      ...
      suiviLinkLabel: "Vedi lo stato del mio progetto",
      signature: "A presto,<br>Thomas",
    },
    paymentReceipt: {
    ...
    clientMessage: {
      preview: "Ha un nuovo messaggio da Calyroc.",
      heading: "Messaggio da Calyroc",
      suiviLinkLabel: "Vedi lo stato del mio progetto",
      signature: "A presto,<br>Thomas",
    },
  },
